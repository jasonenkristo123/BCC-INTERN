    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 lg:px-8">
            <div className="bg-white rounded-xl shadow-lg p-4 lg:p-8">
                ...
                <div>
                    <h3 className="pt-4 text-xs sm:text-base lg:text-lg xl:text-xl font-roboto-400 mb-2">Total Bahan</h3>
                    <div className="w-full bg-gray-200 rounded-full h-3 flex overflow-hidden">
                        <div className="bg-text-primary h-full" style={{ width: '40%' }}></div>
                        <div className="bg-orange-400 h-full" style={{ width: '35%' }}></div>
                    ...
                    <div className="mt-2 flex flex-wrap gap-2 sm:gap-4">
                        ...
                        <div className="flex items-center gap-2 sm:gap-4">
                            ...
                            <p className="font-roboto-400 text-xs sm:text-base">Kedaluwarsa</p>
                        </div>
                    </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 lg:p-8">
                ...
                <div className="flex gap-2 items-center mt-8">
                    ...
                    <Image
                        ...
                        className="w-4 h-4"
                    />
                    <p className="text-merah font-roboto-400">
                        12% dari bulan lalu
                    </p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 lg:p-8">
                ...
                <div className="flex flex-col justify-center mt-4">
                    <div className="flex gap-4">
                        ...
                        <Image src='/kategori/sayur.webp' alt="sayur" width={32} height={32} className="w-14 h-14"/>
                    ...
                    <div className="flex gap-4 mt-4">
                        ...
                        <Image src='/kategori/buahbuah.webp' alt="sayur" width={32} height={32} className="w-14 h-14"/>
                        <div className="font-roboto-500">
                            <h4>
                                Buah
                            </h4>
                ...
                <div>
                    <Button variant="primary" size="lg" className="w-full mt-4 hover:bg-text-primary hover:text-white">
                        Lihat Semua Detail
                    </Button>
                </div>
            </div>
