...
import { filterItemsByMonth, formatCurrency, getExpiryStatus } from "@/shared/utils/utils";
...
export default function WasteTrackerTrend() {
    ...
    const safe = filteredItemMonth.filter((item) => getExpiryStatus(item.expiredEstimation).status === "safe");
    const warning = filteredItemMonth.filter((item) => getExpiryStatus(item.expiredEstimation).status === "warning");
        ...
        <div className="px-4 lg:px-8 my-8 grid grid-cols-1 sm:grid-cols-2 gap-6 grid-rows-5">
            <div className="row-span-5 bg-white rounded-xl p-6 h-[482px] shadow-lg">
                <div className="flex items-center justify-between pb-8">
                    ...
                    <p className="font-roboto-400 text-hitamdikit text-base">
                        Bulanan
                    </p>
                </div>
                <TrendChart />
            ...
            <div className="row-span-3 bg-white h-[268px] rounded-xl py-8 px-6">
                ...
                <Button variant="primary" href="/bahan-saya" size="lg" className="bg-text-primary font-roboto-500 text-white text-base mt-4">
            ...
            <div className="row-span-2 bg-white h-[182px] rounded-xl py-8 px-6 shadow-lg">
                ...
                <div className="mt-3 flex gap-3">
                    <div className="w-[70px] h-[70px] rounded-full border-10 border-text-primary flex items-center justify-center">
                        <span className="font-roboto-500 text-base sm:text-lg lg:text-xl xl:text-2xl text-hitamdikit">86</span>
                    </div>
                    <div>
