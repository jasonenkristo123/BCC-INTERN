    ...
    return (
        <section className="relative w-full h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div
                    className="absolute bottom-[9%] right-[8%] w-[222px] h-[182px]">
                    <Image src="/assets/daging.webp"
                        alt="Meat Icon"
                        priority
                        quality={100}
                        width={677}
