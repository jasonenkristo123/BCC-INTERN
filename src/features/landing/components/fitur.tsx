...
export default function FiturPage() {
    return (
        <section id="fitur" className="w-full min-h-screen bg-lightblue py-15 md:py-24">
            <div className="px-6 md:px-12 lg:px-20 w-full max-w-360 mx-auto">
                ...
                <div className="mb-10 lg:mb-14">
                    ...
                    <p className="text-base md:text-lg lg:text-xl font-roboto-400 text-text-secondary w-full tracking-wider">
                        Dirancang untuk memudahkan gaya hidup hemat dan berkelanjutan melalui
                        manajemen inventori makanan yang pintar.
                    </p>
                </div>
