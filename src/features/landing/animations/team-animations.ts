...
export const getCardVariants = (screen: Breakpoint = 'xl'): Variants => {
    let activeW = 400; let inactiveW = 242; let gap = 30;
    if (screen === 'lg') { activeW = 360; inactiveW = 200; gap = 32; }
    if (screen === 'sm') { activeW = 300; inactiveW = 165; gap = 24; }
    if (screen === 'mobile') { activeW = 240; inactiveW = 130; gap = 16; }
