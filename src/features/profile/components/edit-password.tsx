...
import { TEditPasswordSchema, EditPasswordSchema } from "../schemas/profile-form-schemas";
    ...
    return (
        <div className="bg-white rounded-xl shadow-md w-full p-8 sm:p-12">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                    <label htmlFor="kata-sandi-saat-ini" className="font-roboto-400 text-base sm:text-lg lg:text-xl block">
                        Kata Sandi Saat Ini
                    </label>
                    <input
                        type="text"
                ...
                <div>
                    <label htmlFor="kata-sandi-baru" className="font-roboto-400 text-base sm:text-lg lg:text-xl block">
                        Kata Sandi Baru
                    </label>
                    <input
                        type="text"
