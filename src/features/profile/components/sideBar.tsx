            ...
            <div className="w-full p-8 sm:p-10 bg-white rounded-xl shadow-md">
                {sidebarData.map((links) => (
                    <Link href={links.href} key={links.desc}>
                        <div onClick={() => setActiveNav(links.href)} className={`${activeNav === links.href ? 'bg-primaryskyblue text-text-primary ' : 'text-blackprimary'} flex items-center gap-3 p-4 rounded-full mb-2 cursor-pointer`}>
                            <div
                ...
                <div className="flex items-center gap-3 p-4 rounded-lg cursor-pointer">
                    <Image src="/assets/logout.webp" width={24} height={24} alt="logout" />
