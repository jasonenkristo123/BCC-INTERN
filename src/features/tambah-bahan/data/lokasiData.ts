...
export const saranPenyimpanan: Record<TKategoriBahan, string> = {
    'Umbi-umbian':
        'Simpan di tempat sejuk, kering, dan gelap (rak/pantry). Hindari kulkas karena suhu rendah dapat mengubah pati menjadi gula dan menurunkan kualitas.',
    'Sayur-sayuran':
    ...
    'Rempah-rempah':
        'Rempah segar simpan di kulkas, sedangkan rempah kering simpan di tempat kering dan tertutup agar tidak lembab.',
    'Bumbu Dapur':
        'Simpan bumbu kering di tempat sejuk dan tertutup. Untuk bumbu cair seperti saus atau kecap, simpan di kulkas setelah dibuka.',
    'Biji-bijian':
        'Simpan di wadah kedap udara di tempat kering untuk mencegah kelembaban dan serangga.',
    'Kacang-kacangan & Legum':
        'Simpan di wadah tertutup di tempat sejuk. Untuk menjaga kualitas lebih lama, dapat disimpan di kulkas.',
}
